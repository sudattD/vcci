...
public class NewsDetailRightAdsSliderAdapter extends PagerAdapter {

    private final Context context;
    private final List<RightAdsItem> bottomAdsItemList;

    public NewsDetailRightAdsSliderAdapter(Context context, List<RightAdsItem> bottomAdsItemList) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        RightAdsItem adItem = bottomAdsItemList.get(position);
        ...
        iv_banner_img.setOnClickListener(v -> {
            ...
            for (RightAdsItem item : bottomAdsItemList){
