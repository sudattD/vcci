...
public class SocialSitesActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String social_site_name = getIntent().getStringExtra("social_site_name");
        String social_url = getIntent().getStringExtra("social_url");

        tvTitle.setText(String.format("VCCI %s", social_site_name));
        ...
        wv_social_sites.loadUrl(social_url);
    }
