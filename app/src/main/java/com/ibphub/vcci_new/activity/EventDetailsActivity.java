...
import com.ibphub.vcci_new.model.events.event_detail.EventDetails;
...
public class EventDetailsActivity extends BaseActivity {
    ...
    private void getEventDetail(String getID) {
        ...
        Call<EventDetailResponse> call = apiService.getEventsDetail("1.0", DEVICE_TYPE, "get-event-details",
                token, "123456", getID);
