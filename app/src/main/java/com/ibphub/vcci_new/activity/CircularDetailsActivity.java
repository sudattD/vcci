...
import com.ibphub.vcci_new.model.circulars.circular_detail.CircularDetails;
...
public class CircularDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.circular_detail_fragment);
        ButterKnife.bind(this);
        setSupportActionBar(toolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);
        tvTitle.setText(getResources().getString(R.string.txt_circular_detail));
    ...
    private void getEventDetail(String getID) {
        ...
        Call<CircularDetailResponse> call = apiService.getCircularDetail("1.0", DEVICE_TYPE, "get-circular-details",
                token, "123456", getID);
        call.enqueue(new Callback<CircularDetailResponse>() {
            @SuppressLint("SetJavaScriptEnabled")
            @Override
            public void onResponse(Call<CircularDetailResponse> call, Response<CircularDetailResponse> response) {
                MyProgressDialog.dismiss();
                assert response.body() != null;
                CircularDetails eventDetails = response.body().getEventDetails();
                ...
                photosAdapter = new PhotosAdapter(CircularDetailsActivity.this, eventDetails.getPhotos());
            ...
            @Override
            public void onFailure(Call<CircularDetailResponse> call, Throwable t) {
