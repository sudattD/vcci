...
import com.ibphub.vcci_new.model.events.event_list.EventItem;
...
public class EventsListAdapter extends RecyclerView.Adapter<EventsListAdapter.MyViewHolder> {
    ...
    public EventsListAdapter(Context context, List<EventItem> eventItemsList, ItemSelectionListener itemSelectionListener) {
    ...
    @NonNull
    @Override
    public EventsListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull EventsListAdapter.MyViewHolder holder, int position) {
