...
import com.ibphub.vcci_new.adapter.MembershipFormAdapter;
...
import com.ibphub.vcci_new.model.membership_form.Membership;
...
import com.ibphub.vcci_new.model.membership_form.OtherDocs;
...
public class MembershipFragment extends Fragment implements ItemSelectionListener {
    ...
    private void getMembershipForms() {
        ...
        Call<MembershipFormsResponse> call = apiService.getMembershipForms("1.0", DEVICE_TYPE, "get-membership",
                token, "123456");
